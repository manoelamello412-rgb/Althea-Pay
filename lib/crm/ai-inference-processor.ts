...
export class AltheaAiInferenceProcessor {
  ...
  constructor() {
    ...
    this.llmEndpoint = engineBaseUrl ? `${engineBaseUrl}/v1/chat/completions` : ''
    this.aiApiKey = env('ALTHEA_AI_ENGINE_KEY')
    this.aiModel = env('ALTHEA_AI_ENGINE_MODEL') || 'althea-reasoning'

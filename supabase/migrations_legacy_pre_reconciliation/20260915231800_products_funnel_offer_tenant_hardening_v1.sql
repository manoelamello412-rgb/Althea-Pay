...
-- Products: canonical tenant policy set. Application mutations remain mediated by the product RPCs.
...
-- Funnel offers are the product-to-funnel association surface and must share the funnel organization boundary.

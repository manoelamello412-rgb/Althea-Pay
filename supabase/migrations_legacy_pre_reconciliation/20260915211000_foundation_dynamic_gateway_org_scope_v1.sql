-- Foundation: dynamic gateway provisioning must bind the gateway to the caller's active tenant.
-- The credential remains user-owned; the gateway itself is tenant-owned.

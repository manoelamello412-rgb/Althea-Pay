...
declare u uuid; s jsonb; id uuid;
begin
 ...
 insert into public.crm_predictive_evaluations(user_id,conversation_id,model_version,predicted_conversion,predicted_recovery,predicted_ltv,actual_conversion,actual_recovery,actual_ltv,evaluated_at)
 values(u,p_conversation_id,coalesce(s->>'method','deterministic_behavioral_v1'),(s->>'conversion_probability')::numeric/100,(s->>'recovery_probability')::numeric/100,(s->>'ltv_propensity')::numeric/100,null,null,null,null)

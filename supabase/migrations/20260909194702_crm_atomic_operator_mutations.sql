...
begin
  ...
  insert into public.crm_messages(
    ...
    p_conversation_id,v_user_id,'outbound','webchat',v_body,
    jsonb_build_object('source','crm_operator','mutation','atomic'),v_user_id,p_client_message_id
...
create or replace function public.crm_operator_set_status(
  p_conversation_id uuid,
  p_status text
)

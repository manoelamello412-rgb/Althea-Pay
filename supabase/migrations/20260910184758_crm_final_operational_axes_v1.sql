...
create table if not exists public.crm_team_members (
 ...
 agent_id uuid references public.crm_agents(id) on delete cascade,
...
create table if not exists public.crm_tasks (
 ...
 assigned_to uuid, title text not null, description text,
...
create table if not exists public.crm_segments (
 id uuid primary key default gen_random_uuid(), user_id uuid not null references auth.users(id) on delete cascade,
 name text not null, description text, definition jsonb not null default '{}'::jsonb,

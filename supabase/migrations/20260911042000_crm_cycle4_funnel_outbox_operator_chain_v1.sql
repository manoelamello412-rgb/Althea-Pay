create or replace function public.crm_operator_send_message(p_conversation_id uuid,p_body text,p_client_message_id text default null)
returns public.crm_messages language plpgsql security definer set search_path=public as $function$

-- Consolidate equivalent permissive gateway SELECT policies and cover tenant-scoped foreign keys.
...
drop policy if exists gateway_payment_attempts_read on public.gateway_payment_attempts;
...
drop policy if exists gateway_transactions_read on public.gateway_transactions;

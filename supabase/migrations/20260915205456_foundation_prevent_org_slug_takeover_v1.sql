-- Foundation: prevent an authenticated caller from attaching to an existing organization by slug.
...
begin
  ...
  if v_org_id is not null then raise exception 'ORGANIZATION_SLUG_ALREADY_EXISTS' using errcode='23505'; end if;

-- Core scheduler/recovery primitives. External scheduler invokes core-worker.
...
begin
  ...
  set status='pending', locked_at=null, locked_by=null,
      ...
      last_error=coalesce(last_error,'worker_lock_timeout'), updated_at=now()
...
select id,user_id,job_type,aggregate_type,aggregate_id,payload,attempts,max_attempts,last_error,created_at,updated_at

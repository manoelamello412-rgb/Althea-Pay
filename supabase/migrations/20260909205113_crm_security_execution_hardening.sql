...
-- Keep public funnel chat callable only by the anonymous webchat role;
-- keep operator/intelligence functions callable only by authenticated operators.
...
-- Trigger-only functions are not part of the exposed CRM API surface.

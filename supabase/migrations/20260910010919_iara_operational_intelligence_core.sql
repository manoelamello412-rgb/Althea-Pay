...
CREATE INDEX IF NOT EXISTS idx_iara_telemetry_metric_window ON public.iara_operational_telemetry(tenant_id, metric, observed_at DESC);
CREATE INDEX IF NOT EXISTS idx_iara_telemetry_entity_window ON public.iara_operational_telemetry(tenant_id, entity_type, entity_id, observed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_iara_anomalies_tenant_created ON public.iara_anomalies(tenant_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_iara_anomalies_active ON public.iara_anomalies(tenant_id, status, severity, last_observed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_iara_alerts_tenant_status ON public.iara_proactive_alerts(tenant_id, status, severity, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_iara_evaluations_tenant_created ON public.iara_evaluations(tenant_id, created_at DESC);

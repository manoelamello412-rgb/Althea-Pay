...
create or replace function public.claim_gateway_payment_link_execution(
 p_worker_id text,
...
create or replace function public.complete_gateway_payment_link_execution(
 p_command_id uuid,
...
create or replace function public.fail_gateway_payment_link_execution(
 p_command_id uuid,
 p_error_code text,

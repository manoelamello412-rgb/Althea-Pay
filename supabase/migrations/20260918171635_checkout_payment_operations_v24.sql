...
CREATE OR REPLACE FUNCTION public.checkout_operations_detail_v1(p_checkout_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION public.checkout_operations_page_v1(p_limit integer DEFAULT 50, p_cursor_created_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_cursor_id uuid DEFAULT NULL::uuid, p_status text DEFAULT NULL::text, p_query text DEFAULT NULL::text, p_funnel_id text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'private', 'pg_catalog'
...
CREATE OR REPLACE FUNCTION public.payment_operations_detail_v1(p_transaction_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'private', 'pg_catalog'
...
CREATE OR REPLACE FUNCTION public.payment_operations_page_v1(p_limit integer DEFAULT 50, p_cursor_created_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_cursor_id uuid DEFAULT NULL::uuid, p_status text DEFAULT NULL::text, p_query text DEFAULT NULL::text, p_funnel_id text DEFAULT NULL::text, p_gateway_id text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public', 'private', 'pg_catalog'
...
revoke all on function public.checkout_operations_detail_v1(p_checkout_id uuid) from public,anon;
grant execute on function public.checkout_operations_detail_v1(p_checkout_id uuid) to authenticated;

revoke all on function public.checkout_operations_page_v1(p_limit integer, p_cursor_created_at timestamp with time zone, p_cursor_id uuid, p_status text, p_query text, p_funnel_id text) from public,anon;
grant execute on function public.checkout_operations_page_v1(p_limit integer, p_cursor_created_at timestamp with time zone, p_cursor_id uuid, p_status text, p_query text, p_funnel_id text) to authenticated;

revoke all on function public.payment_operations_detail_v1(p_transaction_id uuid) from public,anon;
grant execute on function public.payment_operations_detail_v1(p_transaction_id uuid) to authenticated;

revoke all on function public.payment_operations_page_v1(p_limit integer, p_cursor_created_at timestamp with time zone, p_cursor_id uuid, p_status text, p_query text, p_funnel_id text, p_gateway_id text) from public,anon;
grant execute on function public.payment_operations_page_v1(p_limit integer, p_cursor_created_at timestamp with time zone, p_cursor_id uuid, p_status text, p_query text, p_funnel_id text, p_gateway_id text) to authenticated;

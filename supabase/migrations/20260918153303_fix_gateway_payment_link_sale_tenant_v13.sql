...
revoke all on function public.project_gateway_payment_link_sale() from public,anon,authenticated;
grant execute on function public.project_gateway_payment_link_sale() to service_role;

...
import { CircleDollarSign, GitBranch, LayoutDashboard, MessageCircle, Network, Search, Settings2, Sparkles, Webhook, X } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[var(--althea-bg)] text-white antialiased">
      <header className="fixed inset-x-0 top-0 z-[100] h-[82px] border-b border-white/[0.065] bg-[rgba(7,12,10,0.96)] px-4 backdrop-blur-2xl sm:px-5">
        <div className="mx-auto flex h-full w-full max-w-[1440px] items-center">
          <button type="button" onClick={() => selectTab('dashboard')} aria-label="Ir para o Dashboard" className="flex h-[72px] min-w-0 shrink items-center justify-start rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-[rgba(29,184,84,0.4)]"><img src="/althea-logo-inner.PNG" alt="Althea Pay" className="h-[68px] w-auto max-w-[280px] object-contain drop-shadow-[0_0_26px_rgba(29,184,84,0.24)] sm:h-[74px] sm:max-w-[310px]" /></button>

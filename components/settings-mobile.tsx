...
import { ChevronRight, CircleDollarSign, FileText, LogOut, ShieldCheck, Sparkles, UserRound } from 'lucide-react'
...
const items=[
 ...
 ['Assistente Iara',Sparkles,'Personalidade, contexto e autonomia da IA'],
] as const

export default function SettingsMobile(){
 const db=useMemo(()=>createSupabaseBrowserClient(),[])
 const [active,setActive]=useState('configuracoes')

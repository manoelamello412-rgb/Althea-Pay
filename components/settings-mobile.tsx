...
export default function SettingsMobile() {
  ...
  if (currentSubPage === 'integracoes') return <div className="relative min-h-[500px] space-y-5 pb-32 font-['Space_Grotesk'] text-white"><IntegracoesSettingsPage /></div>

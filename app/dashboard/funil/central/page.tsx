...
export default function FunnelCentralPage() {
  ...
  return <div className="min-h-screen bg-[#020203] pb-32 text-white">
    <header className="sticky top-0 z-40 border-b border-white/[0.05] bg-[#020203]/90 px-4 py-3 backdrop-blur-xl"><div className="mx-auto flex max-w-5xl items-center justify-between gap-3"><div><p className="text-[9px] font-bold uppercase tracking-[0.2em] text-emerald-400">ALTHEA PAY / FUNIS</p><h1 className="mt-1 text-lg font-bold">Central comercial</h1></div><div className="flex gap-2"><button type="button" onClick={() => void load(selectedId)} className="grid h-9 w-9 place-items-center rounded-xl border border-white/[0.06] text-zinc-400 hover:text-white" aria-label="Atualizar"><RefreshCw className="h-4 w-4" /></button><a href="/dashboard/funil" className="flex h-9 items-center gap-1.5 rounded-xl border border-emerald-500/25 px-3 text-[10px] font-bold text-emerald-400"><Settings2 className="h-3.5 w-3.5" /> CONEXÃO</a></div></div></header>

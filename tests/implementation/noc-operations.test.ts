...
describe('Revenue OS NOC', () => {
  ...
  it('refreshes tenant operational state from realtime without exposing raw log scans', async () => {
    const page = await readFile('app/dashboard/noc/page.tsx', 'utf8')
  ...
  it('removes the obsolete CRM observability endpoint after canonical NOC adoption', async () => {

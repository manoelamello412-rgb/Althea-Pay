...
const requiredFiles=["supabase/functions/gateway-orchestrator/index.ts","supabase/functions/gateway-provider-adapter/index.ts","supabase/functions/gateway-connection-test/index.ts","supabase/functions/checkout-engine-v2/index.ts","supabase/functions/gateway-webhook/index.ts","supabase/functions/gateway-webhook-processor/index.ts","supabase/functions/althea-public-api/index.ts","supabase/functions/althea-webhook/index.ts","supabase/functions/health/index.ts","supabase/functions/iara-ai-core/index.ts","supabase/functions/iara-copilot/index.ts","supabase/functions/iara-funnel-builder/index.ts","supabase/functions/iara-funnel-activate/index.ts","supabase/functions/iara-commercial-intervention/index.ts","supabase/functions/iara-commercial-intervention-worker/index.ts","supabase/functions/iara-daily-report/index.ts","supabase/functions/iara-daily-report-worker/index.ts","supabase/functions/iara-financial-confirm/index.ts","supabase/functions/iara-financial-command/index.ts","app/dashboard/noc/page.tsx","docs/OBSERVABILITY.md","scripts/load-smoke.mjs"]

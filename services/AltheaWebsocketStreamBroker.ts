...
function createEventId():string{if(typeof crypto==='undefined'||typeof crypto.randomUUID!=='function')throw new Error('Secure random UUID is unavailable.') ;return crypto.randomUUID()}
